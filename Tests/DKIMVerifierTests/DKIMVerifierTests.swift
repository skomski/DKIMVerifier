    ...
    final class DKIMVerifierTests: XCTestCase {
        ...
        func testRFC822MessageParsing() {
              ...
              3
              """
              XCTAssertEqual(try DKIMVerifier.parseRFC822Message(message: simple_message).0, [DKIMVerifier.KeyValue(key: "help", value: " 1\r\n  2\r\n")])
              ...
              DDD: 3
              """
              XCTAssertEqual(try DKIMVerifier.parseRFC822Message(message: multiple_headers).0, [DKIMVerifier.KeyValue(key: "habba", value: "1\r\n"),
              ...
              """
              XCTAssertEqual(try DKIMVerifier.parseRFC822Message(message: duplicate_headers).0, [DKIMVerifier.KeyValue(key: "habba", value: "1\r\n"),
                                                                                                DKIMVerifier.KeyValue(key: "habba", value: "1\r\n"),
                                                                                                DKIMVerifier.KeyValue(key: "habbA", value: "1\r\n d\r\n")])
              XCTAssertEqual(try DKIMVerifier.parseRFC822Message(message: duplicate_headers).1, "duplicate_headers\r\n")
        }

        func testParseTagValueList() {
              XCTAssertEqual(try DKIMVerifier.parseTagValueList(raw_list: "help=1"), ["help": "1"])
              XCTAssertEqual(try DKIMVerifier.parseTagValueList(raw_list: "helP=1; Otto=2"), ["helP": "1", "Otto": "2"])
              XCTAssertEqual(try DKIMVerifier.parseTagValueList(raw_list: "helP=1; Otto= 2"), ["helP": "1", "Otto": "2"])
              XCTAssertEqual(try DKIMVerifier.parseTagValueList(raw_list: "helP=1; Otto= 2 2 "), ["helP": "1", "Otto": "2 2"])
              XCTAssertEqual(try DKIMVerifier.parseTagValueList(raw_list: "helP=1; Otto= 2 2 ;"), ["helP": "1", "Otto": "2 2"])
              XCTAssertEqual(try DKIMVerifier.parseTagValueList(raw_list: "helP=1; Otto= 2 2 ;"), ["helP": "1", "Otto": "2 2"])
              XCTAssertEqual(try DKIMVerifier.parseTagValueList(raw_list: "helP=1; Otto= 2\n2\n ;"), ["helP": "1", "Otto": "2\n2"])


            XCTAssertThrowsError(try DKIMVerifier.parseTagValueList(raw_list: "help=1; help=2"), "duplicate value") { error in
              XCTAssertEqual(error as! DKIMVerifier.DKIMError, DKIMVerifier.DKIMError.tagValueListParsingError(message: "duplicate key: help"))
            }

            XCTAssertThrowsError(try DKIMVerifier.parseTagValueList(raw_list: "help=;"), "no value for key help") { error in
              XCTAssertEqual(error as! DKIMVerifier.DKIMError, DKIMVerifier.DKIMError.tagValueListParsingError(message: "no value for key: help"))
            }
